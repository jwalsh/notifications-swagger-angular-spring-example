...
public class ModelError   {
  ...
  **/
  ...
  public ModelError error(String error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public ModelError errors(List<String> errors) {
    this.errors = errors;
    return this;
  }

  public ModelError addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.message, modelError.message) &&
        Objects.equals(this.error, modelError.error) &&
        Objects.equals(this.errors, modelError.errors);
  }
